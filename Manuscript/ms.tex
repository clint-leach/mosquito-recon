...
These data provide us with 243 weeks (week 1 of 2008 through week 34 of 2012) of total city-wide counts of trapped gravid female \emph{Aedes aegypti}.
...
Despite this, our simulations suggest that control is likely to be relatively less effective when implemented during an outbreak, likely due to the large number of infectious human hosts available to transmit to the remaining (and rapidly rebounding) mosquito population \cite{Newton1992, Burattini2008}.
...
Though, the immediate effects of mosquito control implemented during the decline phase of an outbreak may be masked by the natually fading transmission intensity \cite{Stoddard2014}, our results nonetheless indicate long-term benefits that become apparent in the following outbreak.
...
These control efforts may affect our estimates of the mosquito demographic rates, but should not influence our understanding of dengue dynamics, since we are not focusing on the factors driving mosquito dynamics, but rather in how the realized mosquito dynamics (whether forced by human intervention or environmental factors) fit into the broader epidemiological picture.
That said, our mosquito control simulations should be interepreted as exploring the effect of an additional pulse of city-wide control on top of the existing control activities.
