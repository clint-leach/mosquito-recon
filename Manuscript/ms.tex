...
Despite this, our simulations suggest that control is likely to be relatively ineffective when implemented during an outbreak, likely due to the large number of infectious human hosts available to transmit to the remaining (and rapidly rebounding) mosquito population \cite{Newton1992, Burattini2008}.
...
Stoddard \emph{et al.} \cite{Stoddard2014}, in their study of the dynamics of dengue in Iquitos, Peru, found that the effects of control implemented during the decline phase of an outbreak were difficult to detect in the presence of natually fading transmission intensity.
