...
Where possible, we specified informative prior distributions for these parameters based on existing laboratory and field studies (see Table 1 for means and \nameref{S1} for detailed explanations).

\begin{table}[!ht]
\label{parameters}
\begin{adjustwidth}{-2.25in}{0in} 
\begin{center}
\caption{Model parameters and their values.  Parameters above the rule are fixed, while parameters below the rule are random.  The values in parentheses after the posterior means give the 80$\%$ credible interval. See \nameref{S1} for a full description of all prior distributions.}
...
The marginal posterior means of the $\epsilon_{\nu t}$ forcing the mosquito mortality process exhibited a higher-frequency periodic oscillation (\nameref{S1_fig}), although the marginal posterior distribution of each $\epsilon_{\nu t}$ overlapped zero.
...
The periodic structure in the time series of the posterior means of the $\epsilon_{\nu}$ (\nameref{S1_fig}) suggests that these terms were accounting for more than just noise, and there may have been some unmodeled process influencing fluctuations in mosquito mortality and/or transmission.
...
\newblock {Defining challenges and proposing solutions for control of the virus
  vector \emph{Aedes aegypti}}.
\newblock PLoS Med. 2008;5(3):0362--0366.
\newblock doi:{10.1371/journal.pmed.0050068}.

\bibitem{Scott2010b}
Scott TW, Morrison AC.
\newblock {Longitudinal field studies will guide a paradigm shift in Dengue
  prevention}.
...
\bibitem{Scott2010a}
Scott TW, Morrison AC.
\newblock {Vector dynamics and transmission of dengue virus: implications for
  dengue surveillance and prevention strategies}.
\newblock Dengue Virus. 2010;(338):161.
\newblock doi:{10.1007/978-3-642-02215-9}.

\bibitem{Bowman2014}
Bowman LR, Runge-Ranzinger S, McCall PJ.
\newblock {Assessing the relationship between vector indices and dengue
...
\newblock {Utility of mosquito surveillance data for spatial prioritization of
  vector control against dengue viruses in three Brazilian cities}.
\newblock Parasites and Vectors. 2015;8(1):1--15.
\newblock doi:{10.1186/s13071-015-0659-y}.

\bibitem{Cromwell2017}
Cromwell EA, Stoddard ST, Barker CM, {Van Rie} A, Messer WB, Meshnick SR,
  et~al.
\newblock {The relationship between entomological indicators of \emph{Aedes
  aegypti} abundance and dengue virus infection}.
\newblock PLoS Negl Trop Dis. 2017;11(3):e0005429.
\newblock doi:{10.1371/journal.pntd.0005429}.

\bibitem{Koelle2004}
Koelle K, Pascual M.
\newblock {Disentangling extrinsic from intrinsic factors in disease dynamics:
...
\newblock {Refractory periods and climate forcing in cholera dynamics.}
...
\newblock {Noise and nonlinearity in measles epidemics: combining mechanistic
  and statistical approaches to population modeling.}
\newblock Am Nat. 1998;151(5):425--440.
\newblock doi:{10.1086/286130}.

\bibitem{Grenfell2002}
Grenfell BT, Bj{\o}rnstad ON, Finkenst{\"{a}}dt BF.
\newblock {Dynamics of measles epidemics: Scaling noise, determinism, and
  predictability with the TSIR model}.
\newblock Ecol Monogr. 2002;72(2):185--202.
\newblock doi:{10.1890/0012-9615(2002)072[0185:DOMESN]2.0.CO;2}.

\bibitem{Reilly2005}
Reilly C, Zeringue A.
\newblock {Improved predictions of lynx trappings using a biological model}.
...
\bibitem{Buckland2007}
Buckland ST, Newman KB, Fern{\'{a}}ndez C, Thomas L, Harwood J.
\newblock {Embedding population dynamics models in inference}.
\newblock Stat Sci. 2007;22(1):44--58.
\newblock doi:{10.1214/088342306000000673}.

\bibitem{Hotelling1927}
Hotelling H.
\newblock {Differential equations subject to error, and population estimates}.
...
\bibitem{Berliner1996}
Berliner LM.
\newblock {Hierarchical Bayesian time series models}.
...
\newblock {Accounting for uncertainty in ecological analysis: the strengths and
  limitations of hierarchical statistical modeling.}
...
\bibitem{Eiras2009}
Eiras {\'{A}}, Resende M.
\newblock {Preliminary evaluation of the ``Dengue-MI" technology for
  \emph{Aedes aegypti} monitoring and control}.
...
Lana RM, Morais MM, de~Lima TFM, Carneiro TGdS, Stolerman LM, dos Santos JPC,
  et~al.
\newblock {Assessment of a trap based \emph{Aedes aegypti} surveillance program
  using mathematical modeling}.
\newblock PLoS ONE. 2018;13(1):1--16.

\bibitem{Wearing2006}
Wearing HJ, Rohani P.
\newblock {Ecological and immunological determinants of dengue epidemics.}
...
\newblock {Assessing North American influenza dynamics with a statistical SIRS
  model.}
...
\newblock {Estimating dengue transmission intensity from case-notification data
...
\newblock {Immune status alters the probability of apparent illness due to
  dengue virus infection: Evidence from a pooled analysis across multiple
  cohort and cluster studies}.
\newblock PLoS Neglected Tropical Diseases. 2017;11(9):e0005926.
\newblock doi:{10.1371/journal.pntd.0005926}.

\bibitem{Olkowski2013}
Olkowski S, Forshey BM, Morrison AC, Rocha C, Vilcarromero S, Halsey ES, et~al.
\newblock {Reduced risk of disease during postsecondary dengue virus
  infections.}
...
\newblock {Symptomatic versus inapparent outcome in repeat dengue virus
  infections is influenced by the time interval between infections and study
  year}.
\newblock PLoS Neglected Tropical Diseases. 2013;7(8):e2357.
\newblock doi:{10.1371/journal.pntd.0002357}.

\bibitem{Schwartz2005}
Schwartz IB, Shaw LB, Cummings DAT, Billings L, Mccrary M, Burke DS.
\newblock {Chaotic desynchronization of multistrain diseases}.
...
\bibitem{Chan2012}
Chan M, Johansson MA.
\newblock {The incubation periods of dengue viruses}.
\newblock PLoS One. 2012;7(11):1--7.
\newblock doi:{10.1371/journal.pone.0050972}.

\bibitem{Lloyd2001}
Lloyd AL.
\newblock {Realistic distributions of infectious periods in epidemic models:
...
\newblock {Longitudinal studies of \emph{Aedes aegypti} (Diptera: Culicidae) in
  Thailand and Puerto Rico: blood feeding frequency}.
\newblock J Med Entomol. 2000;37(1):89--101.

\bibitem{Brady2013}
Brady OJ, Johansson MA, Guerra CA, Bhatt S, Golding N, Pigott DM, et~al.
\newblock {Modelling adult \emph{Aedes aegypti} and \emph{Aedes albopictus}
...
\newblock {Host and viral features of human dengue cases shape the population
  of infected and infectious \emph{Aedes aegypti} mosquitoes.}
\newblock Proc Natl Acad Sci U S A. 2013;110(22):9072--7.
\newblock doi:{10.1073/pnas.1303395110}.

\bibitem{Cardoso2011a}
Cardoso I, Cabidelle A.
\newblock {Dengue: clinical forms and risk groups in a high incidence city in
...
\newblock {Accuracy of dengue reporting by national surveillance system,
  Brazil}.
\newblock Emerg Infect Dis. 2016;22(2):336--339.
\newblock doi:{10.3201/eid2202.150495}.

\bibitem{Girolami2008}
Girolami M.
\newblock {Bayesian inference for differential equations}.
\newblock Theor Comput Sci. 2008;408(1):4--16.
\newblock doi:{10.1016/j.tcs.2008.07.005}.

\bibitem{Calderhead2011}
Calderhead B, Girolami M.
\newblock {Statistical analysis of nonlinear dynamical systems using
  differential geometric sampling methods}.
\newblock Interface Focus. 2011;1(6):821--835.
\newblock doi:{10.1098/rsfs.2011.0051}.

\bibitem{Leander2014}
Leander J, Lundh T, Jirstrand M.
\newblock {Stochastic differential equations as a tool to regularize the
  parameter estimation problem for continuous time dynamical systems given
...
\newblock {The impact of sequential ultra-low volume ground aerosol
  applications of malathion on the population dynamics of Aedes aegypti (L.)}.
...
\newblock {Effectiveness of peridomestic space spraying with insecticide on
  dengue transmission; Systematic review}.
...
\newblock {The role of seasonality and import in a minimalistic multi-strain
  dengue model capturing differences between primary and secondary infections:
...
\newblock {Estimating the effective reproduction number of dengue considering
  temperature-dependent generation intervals}.
\newblock Epidemics. 2018;25(May):101--111.
\newblock doi:{10.1016/j.epidem.2018.05.011}.

\bibitem{Barsante2015}
Barsante LS, Cordeiro FS, Cardoso RTN, Acebal JL, Paix{\~{a}}o KS, Eiras
  {\'{A}}E.
\newblock {Controle da dengue na esta{\c{c}}{\~{a}}o seca da cidade de
  Curvelo-MG atrav{\'{e}}s de um modelo preditivo}.
...
\newblock {Optimal timing of insecticide fogging to minimize dengue cases:
  Modeling dengue transmission among various Seasonalities and transmission
  intensities}.
\newblock PLoS Neglected Tropical Diseases. 2011;5(10).
\newblock doi:{10.1371/journal.pntd.0001367}.

\bibitem{Stoddard2014}
Stoddard ST, Wearing HJ, Jr RCR, Morrison AC, Astete H, Vilcarromero S, et~al.
\newblock {Long-term and seasonal dynamics of dengue in Iquitos, Peru}.
...
\newblock {Forecasting the effectiveness of indoor residual spraying for
  reducing dengue burden}.
\newblock PLoS Neglected Tropical Diseases. 2018;12(6):1--16.
\newblock doi:{10.1371/journal.pntd.0006570}.

\bibitem{TenBosch2016}
ten Bosch QA, Singh BK, Hassan MRA, Chadee DD, Michael E.
\newblock {The role of serotype interactions and seasonality in dengue model
  selection and control: Insights from a pattern matching approach}.
...
\bibitem{Hooker2015}
Hooker G, Ellner SP.
\newblock {Goodness of fit in nonlinear dynamics: Misspecified rates or
  misspecified states?}
\newblock Ann Appl Stat. 2015;9(2):754--776.
\newblock doi:{10.1214/15-AOAS828}.

\bibitem{Maciel-de-Freitas2008}
Maciel{-}de{-}Freitas R.
\newblock {Calculating the survival rate and estimated population density of
  gravid \emph{Aedes aegypti} (Diptera, Culicidae) in Rio de Janeiro, Brazil}.
\newblock Cadernos de Sa{\'{u}}de P{\'{u}}blica. 2008;24(12):2747--2754.

\bibitem{Yang2009}
Yang HM, Macoris MLG, Galvani KC, Andrighetti MTM, Wanderley DMV.
\newblock {Assessing the effects of temperature on the population of
  \emph{Aedes aegypti}, the vector of dengue}.
\newblock Epidemiol Infect. 2009;137(08):1188.
\newblock doi:{10.1017/S0950268809002040}.

\bibitem{Morin2013}
Morin CW, Comrie AC, Ernst K.
\newblock {Climate and dengue transmission: Evidence and implications}.
...
\newblock {Estimating malaria transmission from humans to mosquitoes in a noisy
  landscape}.
...
\newblock {Epidemiological alert: Chikungunya and dengue fever in the
  Americas}; 2014. August.

\bibitem{PAHO2015}
{Pan American Health Organization}, {World Health Organization}.
\newblock {Epidemiological update: Zika virus infection}; 2015. October.

\bibitem{Brady2016}
Brady OJ, Godfray HCJ, Tatem AJ, Gething PW, Cohen JM, McKenzie FE, et~al.
\newblock {Vectorial capacity and vector control: Reconsidering sensitivity to
...
\newblock {Cost-effectiveness of novel system of mosquito surveillance}.
\newblock Emerg Infect Dis. 2013;19(4).

\bibitem{Adams2009}
Adams B, Kapan DD.
\newblock {Man bites mosquito: Understanding the contribution of human movement
...
\newblock {The effects of human movement on the persistence of vector-borne
  diseases.}
\newblock J Theor Biol. 2009;258(4):550--60.
\newblock doi:{10.1016/j.jtbi.2009.02.016}.

\bibitem{Stoddard2009}
Stoddard ST, Morrison AC, Vazquez-Prokopec GM, {Paz Soldan} V, Kochel TJ,
  Kitron U, et~al.
\newblock {The role of human movement in the transmission of vector-borne
  pathogens.}
...
\newblock {Spatial correlation of incidence of dengue with socioeconomic,
...
\newblock {Spatial evaluation and modeling of Dengue seroprevalence and vector
...
\newblock {Spatial patterns and socioecological drivers of dengue fever
  transmission in Queensland, Australia.}
\newblock Environ Health Perspect. 2012;120(2):260--6.
\newblock doi:{10.1289/ehp.1003270}.

\bibitem{DeMattosAlmeida2007}
{de Mattos Almeida} MC, Caiaffa WT, Assun{\c{c}}{\~{a}}o RM, Proietti FA.
\newblock {Spatial vulnerability to dengue in a Brazilian urban area during a
  7-year surveillance.}
