...
To try to prevent these regular outbreaks, Vitoria and many similar cities routinely conduct mosquito control activities, often guided by mosquito surveillance data.
One source for such surveillance data is the MI-Dengue system, implemented by the company Ecovec.
