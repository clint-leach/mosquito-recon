...
In that framework, \cite{Hooker2015} allow the parameters of a differential equation model to change over time and use the resulting time series to differentiate causes of lack-of-fit.
