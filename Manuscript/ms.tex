...
The dynamics of infectious diseases, and ecological systems more broadly, are often driven by the combined efforts of intrinsic non-linearities, seasonality, and stochasticity \cite{Ellner1998,Koelle2004,Bjornstad2001}.
We capture the interplay of these factors largely through our specification of the mosquito mortality process.
As discussed above, the race between mosquito mortality and incubation period introduces a critical bottleneck and non-linearity into the transmission process and the influence of mosquito abundance on human disease.
Moreover, both the incubation period and mosquito lifespan vary seasonally as a result of environmental forcing.
The mechanistic modeling framework allows us to incorporate these critical processes.

As implemented, mosquito mortality is the only source of uncertainty/stochasticity in the transmission process.
This reflects the central role that mosquito mortality likely plays in driving dengue dynamics, but it also means that the estimated mosquito mortality time series could be soaking up other sources of stochasticity or model misspecification.
...
The fact that our estimated mortality rate varies seasonally and increases with temperature above 20 degrees also agrees with the empirical literature on mosquito survival \cite{Yang2009}, though our estimated relationship is generally more extreme than estimated in laboratory studies.
...
Something about the idea that stochastic fluctuations around a seasonally varying mortality rate conspire to drive disease dynamics.
