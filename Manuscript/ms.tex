...
The mismatch between the timing of the most effective control and the peak in mosquito abundance suggests that mosquito abundance alone was an insufficient predictor of the effect of mosquito control, at least at the city-scale.
...
The fact that the effect of mosquito control was mediated by the dynamics of human immunity highlights that dengue, like many other diseases (e.g., cholera \cite{Koelle2004, Koelle2005}), is driven by a complex interplay between seasonal forcing and intrinsic non-linearities \cite{Wearing2006, Reich2013}.
...
These unmodeled components could include additional mosquito population dynamic processes (e.g., aquatic stage dynamics, environmental drivers, or control interventions), or epidemiological processes (e.g., multiple circulating serotypes of the dengue virus).
